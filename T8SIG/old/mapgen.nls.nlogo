...
globals 
[
  WorldRowCount ;rows of world
  WorldColCount ;columns of world
...
to setup 
  ;setup world
  set WorldRowCount 10
  set WorldColCount 10
  set numPatches 50
...
to makeWalls
 ;West Wall
 ask patch -10 10 [set pcolor wallColor]
 ask patch -10 9 [set pcolor wallColor]
 ask patch -10 8 [set pcolor wallColor]
 ask patch -10 7 [set pcolor wallColor]
 ask patch -10 6 [set pcolor wallColor]
 ask patch -10 5 [set pcolor wallColor]
 ask patch -10 4 [set pcolor wallColor]
 ask patch -10 3 [set pcolor wallColor]
 ask patch -10 2 [set pcolor wallColor]
 ask patch -10 1 [set pcolor wallColor]
 ask patch -10 0 [set pcolor wallColor]
 ask patch -10 -1 [set pcolor wallColor]
 ask patch -10 -2 [set pcolor wallColor]
 ask patch -10 -3 [set pcolor wallColor]
 ask patch -10 -4 [set pcolor wallColor]
 ...
 ;North Wall
 ask patch -10 10 [set pcolor wallColor]
 ask patch -9 10 [set pcolor wallColor]
 ask patch -8 10 [set pcolor wallColor]
 ask patch -7 10 [set pcolor wallColor]
 ask patch -6 10 [set pcolor wallColor]
 ask patch -5 10 [set pcolor wallColor]
 ask patch -4 10 [set pcolor wallColor]
 ask patch -3 10 [set pcolor wallColor]
 ask patch -2 10 [set pcolor wallColor]
 ask patch -1 10 [set pcolor wallColor]
 ask patch -0 10 [set pcolor wallColor]
 ask patch 1 10 [set pcolor wallColor]
 ask patch 2 10 [set pcolor wallColor]
 ask patch 3 10 [set pcolor wallColor]
 ask patch 4 10 [set pcolor wallColor]
