  ...
  [
    ...
    [
      ...
      [
        ...
        [
          ;;If the enemy runs out of energy, go wandering.
          Wander
        ]
      ]
    ]
...
to Wander
  ...
  ;;regenerate energy
  if energy < 100 [set energy energy + 1]
  ...
  ;;For example, if only forward and right were options, the list would contain 2 elemenets.  0, and 1.
